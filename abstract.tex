...
The advances introduced in this work contribute foundational methods and empirical evidence toward the emerging area of Programmatically Interpretable Reinforcement Learning for Healthcare.