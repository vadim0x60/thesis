...
Both individual organizations and regulatory authorities often impose requirements onto decision systems that assume their transparency. 
An audit has to be able to establish whether the system displays any illegal patterns such unathorized use of intellectual property, violations of discrimination law, insider trading or clinical malpractice. \todo{citations}.
