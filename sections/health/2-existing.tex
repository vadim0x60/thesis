...
The authors of \emph{GYMIC} solve it with an LSTM \cite{lstm} neural network with 2 additional dense layers attached, see figure \ref{fig:gymic} for the diagram.
