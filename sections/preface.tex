...
Finally, chapter \ref{ch:mimicseq} makes the first step towards a big data driven patient simulator by proposing a sequential dataset for training foundation models in intensive care.
