...
\begin{figure}
    \centering
    \includegraphics{images/PatientModeling.drawio.png}
...
\begin{figure}
    \centering
    \includegraphics{images/PatientModelingInter.drawio.png}
...
\begin{figure}
    \centering
    \includegraphics{images/PSHealth.drawio.png}
...
\newpage
\section{Towards Effective Patient simulators}
...
The shortage of standard benchmarks has been consistently identified as a central roadblock for machine learning in Healthcare
