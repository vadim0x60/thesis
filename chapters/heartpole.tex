...
\begin{remark}
    An earlier revision \cite{liventsevHeartPoleTransparentTask} of this chapter was presented at HEALTHINF 2021. An implementation of HeartPole is available at \cite{liventsevVadim0x60Heartpole2024} 
\end{remark}
...
We introduce a patient simulator inspired by \emph{CartPole} \cite{bartoNeuronlikeAdaptiveElements1983} that trades clinical accuracy off for \emph{simplicity} and \emph{transparency}, while still being \emph{non-trivial} to solve.
