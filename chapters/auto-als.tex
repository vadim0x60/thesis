...
\begin{itemize}
    \item Exercise sets in mathematics, physics and language learning, to name a few fields, are designed to cover all important clusters/corner cases of the subject area, something not guaranteed in regular datasets like logs, business records or text corpora.
