...
Today, this can be done with a \emph{programming copilot} \cite{liangLargeScaleSurveyUsability2024}: a software tool integrated into the text editor as a core feature or an extension, that used a pretrained language model to recommend code snippets based on the context (the code already present in the file).
