...
\nomenclature{PIRL}{Programmatically Interpretable Reinforcement Learning \cite{pirl}, same as RLCEF}
...
\nomenclature{DQN}{Deep Q-Network \cite{mnihPlayingAtariDeep2013,dqn}}
...
\nomenclature{VAE}{Variational Autoencoder \cite{kingma2019introduction}}
...
\nomenclature{ICU}{Intensive Care Unit \cite{WhatIntensiveCare}}
...
\nomenclature{MIMIC}{Medical Information Mart for Intensive Care \cite{mimic}}
